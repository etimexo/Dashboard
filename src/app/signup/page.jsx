...
//     <div className="flex w-full ">
//       <div className="relative w-[60%] h-[100vh]">
//         <Image src={up} layout="fill" objectFit="cover" className="z-0" />
//         <div className="absolute inset-0 bg-[#55418b] bg-opacity-50 z-10"></div>
//       </div>
...
//           <button
//             type="submit"
//             className="bg-blue-600 mt-20 w-full p-2 rounded-md"
//           >
//             Get started
//           </button>
//         </form>
